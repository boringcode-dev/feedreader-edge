  ...
  <body data-app-version="${escapeHtml(data.appVersion)}">
    ...
    <dialog class="config-dialog install-dialog" data-install-dialog>
      <form class="config-dialog-form" method="dialog">
        ...
        <img class="install-dialog-screenshot install-dialog-screenshot-tablet is-hidden" data-install-screenshot-tablet src="/manifest-assets/screenshot-tablet.png?v=1" alt="reader running as an installed app on iPad" width="820" height="1180" loading="lazy" />
